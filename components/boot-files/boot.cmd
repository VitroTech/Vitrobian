run findfdt
setenv boot_part 2
setenv bootargs "console=ttymxc0,115200n8 video=mxcfb0:dev=hdmi,1920x1080m60,if=RGB24,bpp=32 cma=128M rootfstype=ext4 rootdelay=3 rootwait panic=10 root=LABEL=root"
